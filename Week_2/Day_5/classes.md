...
JavaSripts object system is based on _prototypes_ not classes.
...
A blueprint has all the instructions and details needed to build a house, but it is _NOT_ a house.
...
In OOP classes are blueprints that we use to create _instances_ of objects.
